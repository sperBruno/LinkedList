...
{
  public Homework1Grader() {}
  
  public static void main(String[] paramArrayOfString) {
    org.junit.runner.Result localResult = org.junit.runner.JUnitCore.runClasses(new Class[] { ContainsTest.class, InsertSortedTest.class, RemoveMaximumValuesTest.class });
